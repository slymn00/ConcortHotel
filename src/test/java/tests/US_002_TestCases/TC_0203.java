...
public class TC_0203 extends TestBaseRapor {

/*
    1- Yönetici Concort Hotel sayfasina gider.
    2- Yönetici sag ustteki login butonuna tiklar.
    3- Yönetici password textbox'ina gecersiz sifre girer.
...
*/
    ...
    public void test() {
        ...
        extentTest = extentReports.createTest("TC_0203");

        US_002_page us_002_page = new US_002_page();

        us_002_page.concortHotelWrongPasswordLogin();
