...
public class TC_1005 extends TestBaseRapor {
    /*
Book this room Buttonu çalışamalı
...
6-Book this room butonuna tiklar
    ...
    @Test
    public void bookThisRoomButonuAktiflikTesti(){
        extentTest=extentReports.createTest("TC_1005_Book this room butonu","Book this room butonu aktif olmali");
