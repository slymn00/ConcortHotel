...
public class TC_0905 extends TestBaseRapor {
    ...
    //10) Kullanici Delete butonuna tiklar
    @Test
    public void test() throws InterruptedException {

        US_009_page us_009_page=new US_009_page();
        extentTest=extentReports.createTest("US09-TC05 Delete butonu calismali");
        ...
        us_009_page.roomReservationDetailsDegistirDeleteButonu.click();
        String contactSurnameDeleteSonrasiHali=us_009_page.roomReservationDetailsContactSurnameKutusu.getText();
        softAssert.assertNotEquals(contactSurnameIlkHali,contactSurnameDeleteSonrasiHali,"Surname in ilk hali ile Delete islemi sonraki halinin ayni oldugu goruldu ve yapilan delete isleminin sisteme islenmedigi anlasildi, TEST FAILED");
        extentTest.info("Surname in ilk hali ile Delete islemi sonraki halinin ayni oldugu goruldu ve yapilan delete isleminin sisteme islenmedigi anlasildi, TEST FAILED");
