...
public class TC_0305  extends TestBaseRapor {
    ...
    public void logIn() throws InterruptedException {
        ...
        //21 - save butonuna ok dedik
        us_003_page.regOkButton.click();

        //22- You have been succesfully registered to the system, now you can login using link below: yazisinin gorulmesi
        Assert.assertTrue(us_003_page.linkBelow.isDisplayed());
